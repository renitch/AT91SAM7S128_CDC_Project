...
extern void AT91F_US_Put( char *buffer, unsigned int length);
...
int main ( void )
{
    ...
    AT91F_PIO_ClearOutput( AT91C_BASE_PIOA, wifi_GPIO0 ) ;
    //AT91F_PIO_SetOutput( AT91C_BASE_PIOA, wifi_GPIO0 ) ;
    
    AT91F_PIO_ClearOutput( AT91C_BASE_PIOA, wifi_CH_PD ) ;
    AT91F_PIO_ClearOutput( AT91C_BASE_PIOA, wifi_RST ) ;
    Delay_mS(300000);
